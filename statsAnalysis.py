...
data = pd.read_csv('/Users/tliv0001/PycharmProjects/BN-understanding/processedData.csv')
...
chain_col = { 1: ['Chain_Q1_Cond1_P_Decreased', 'Chain_Q1_Distance', 'Chain_Q1_P_AnsWithinRange', 'Chain_Q1_ReadCPT', 'Chain_Q1_Cond2_P', 'Chain_Q1_Cond3_P', 'Chain_Q1_Distance_norm', 'Chain_Q1_Cond1_P_The_Same', 'Chain_Q1_P_Range'],
              2: ['Chain_Q2_Cond1_P_Decreased', 'Chain_Q2_Distance', 'Chain_Q2_P_AnsWithinRange', 'Chain_Q2_ReadCPT', 'Chain_Q2_Cond2_P', 'Chain_Q2_Cond3_P', 'Chain_Q2_Distance_norm', 'Chain_Q2_Cond1_P_The_Same', 'Chain_Q2_P_Range'],
              3: ['Chain_Q3_Cond1_P_Increased', 'Chain_Q3_Distance', 'Chain_Q3_P_AnsWithinRange', 'Chain_Q3_ReadCPT', 'Chain_Q3_Cond2_P', 'Chain_Q3_Cond3_P', 'Chain_Q3_Distance_norm', 'Chain_Q3_Cond1_P_The_Same', 'Chain_Q3_P_Range'],
              4: ['Chain_Q4_Cond1_P_Increased', 'Chain_Q4_Distance', 'Chain_Q4_P_AnsWithinRange', 'Chain_Q4_ReadCPT', 'Chain_Q4_Cond2_P', 'Chain_Q4_Cond3_P', 'Chain_Q4_Distance_norm', 'Chain_Q4_Cond1_P_The_Same', 'Chain_Q4_P_Range'],
              5: ['Chain_Q5_Cond1_P_The_Same', 'Chain_Q5_Distance', 'Chain_Q5_P_AnsWithinRange', 'Chain_Q5_ReadCPT', 'Chain_Q5_Cond2_P', 'Chain_Q5_Cond3_P', 'Chain_Q5_Distance_norm', 'Chain_Q5_Cond1_P_The_Same', 'Chain_Q5_P_Range']}
                  
CC_col = { 1: ['CC_Q1_Cond1_P_Increased','CC_Q1_Distance', 'CC_Q1_P_AnsWithinRange', 'CC_Q1_ReadCPT', 'CC_Q1_Cond2_P', 'CC_Q1_Cond3_P', 'CC_Q1_Distance_norm', 'CC_Q1_Cond1_P_The_Same', 'CC_Q1_P_Range'],
              2: ['CC_Q2_Cond1_P_Increased', 'CC_Q2_Distance', 'CC_Q2_P_AnsWithinRange', 'CC_Q2_ReadCPT', 'CC_Q2_Cond2_P', 'CC_Q2_Cond3_P', 'CC_Q2_Distance_norm', 'CC_Q2_Cond1_P_The_Same', 'CC_Q2_P_Range'],
              3: ['CC_Q3_Cond1_P_Increased', 'CC_Q3_Distance', 'CC_Q3_P_AnsWithinRange', 'CC_Q3_ReadCPT', 'CC_Q3_Cond2_P', 'CC_Q3_Cond3_P', 'CC_Q3_Distance_norm', 'CC_Q3_Cond1_P_The_Same', 'CC_Q3_P_Range'],
              4: ['CC_Q4_Cond1_P_Decreased', 'CC_Q4_Distance', 'CC_Q4_P_AnsWithinRange', 'CC_Q4_ReadCPT', 'CC_Q4_Cond2_P', 'CC_Q4_Cond3_P', 'CC_Q4_Distance_norm', 'CC_Q4_Cond1_P_The_Same', 'CC_Q4_P_Range'],
              5: ['CC_Q5_Cond1_P_Increased', 'CC_Q5_Distance', 'CC_Q5_P_AnsWithinRange', 'CC_Q5_ReadCPT', 'CC_Q5_Cond2_P', 'CC_Q5_Cond3_P', 'CC_Q5_Distance_norm', 'CC_Q5_Cond1_P_The_Same', 'CC_Q5_P_Range'],
              6: ['CC_Q6_Cond1_P_The_Same',  'CC_Q6_Distance', 'CC_Q6_P_AnsWithinRange', 'CC_Q6_ReadCPT', 'CC_Q6_Cond2_P', 'CC_Q6_Cond3_P', 'CC_Q6_Distance_norm', 'CC_Q6_Cond1_P_The_Same', 'CC_Q6_P_Range'],
              7: ['CC_Q7_Cond1_P_Increased', 'CC_Q7_Distance', 'CC_Q7_P_AnsWithinRange', 'CC_Q7_ReadCPT', 'CC_Q7_Cond2_P', 'CC_Q7_Cond3_P', 'CC_Q7_Distance_norm', 'CC_Q7_Cond1_P_The_Same', 'CC_Q7_P_Range']}

CE_col = { 1: ['CE_Q1_Cond1_P_The_Same', 'CE_Q1_Distance', 'CE_Q1_P_AnsWithinRange', 'CE_Q1_ReadCPT', 'CE_Q1_Cond2_P', 'CE_Q1_Cond3_P', 'CE_Q1_Distance_norm', 'CE_Q1_Cond1_P_The_Same', 'CE_Q1_P_Range'],
              2: ['CE_Q2_Cond1_P_Increased', 'CE_Q2_Distance', 'CE_Q2_P_AnsWithinRange', 'CE_Q2_ReadCPT', 'CE_Q2_Cond2_P', 'CE_Q2_Cond3_P', 'CE_Q2_Distance_norm', 'CE_Q2_Cond1_P_The_Same', 'CE_Q2_P_Range'],
              3: ['CE_Q3_Cond1_P_Increased', 'CE_Q3_Distance', 'CE_Q3_P_AnsWithinRange', 'CE_Q3_ReadCPT', 'CE_Q3_Cond2_P', 'CE_Q3_Cond3_P', 'CE_Q3_Distance_norm', 'CE_Q3_Cond1_P_The_Same', 'CE_Q3_P_Range'],
              4: ['CE_Q4_Cond1_P_Increased', 'CE_Q4_Distance', 'CE_Q4_P_AnsWithinRange', 'CE_Q4_ReadCPT', 'CE_Q4_Cond2_P', 'CE_Q4_Cond3_P', 'CE_Q4_Distance_norm', 'CE_Q4_Cond1_P_The_Same', 'CE_Q4_P_Range'],
              5: ['CE_Q5_Cond1_P_Decreased', 'CE_Q5_Distance', 'CE_Q5_P_AnsWithinRange', 'CE_Q5_ReadCPT', 'CE_Q5_Cond2_P', 'CE_Q5_Cond3_P', 'CE_Q5_Distance_norm', 'CE_Q5_Cond1_P_The_Same', 'CE_Q5_P_Range'],
              6: ['CE_Q6_Cond1_P_Increased', 'CE_Q6_Distance', 'CE_Q6_P_AnsWithinRange', 'CE_Q6_ReadCPT', 'CE_Q6_Cond2_P', 'CE_Q6_Cond3_P', 'CE_Q6_Distance_norm', 'CE_Q6_Cond1_P_The_Same', 'CE_Q6_P_Range'],
              7: ['CE_Q7_Cond1_P_Increased', 'CE_Q7_Distance', 'CE_Q7_P_AnsWithinRange', 'CE_Q7_ReadCPT', 'CE_Q7_Cond2_P', 'CE_Q7_Cond3_P', 'CE_Q7_Distance_norm', 'CE_Q7_Cond1_P_The_Same', 'CE_Q7_P_Range']}
...
def DirectionalityTest(data):
    ...
    for qnum in range(1,6): #adding chain
        ...
        rows.append(["chain", qnum, len(data_simple_true)/len(data_simple), len(data_medium_true)/len(data_medium), len(data_hard_true)/len(data_hard), small_medium, medium_large, small_large])
...
##
    ...
    # no-change questions
    small_chain = pd.concat([data_simple[chain_col[1][7]], data_simple[chain_col[2][7]], data_simple[chain_col[3][7]],
                             data_simple[chain_col[4][7]]])
    medium_chain = pd.concat([data_medium[chain_col[1][7]], data_medium[chain_col[2][7]], data_medium[chain_col[3][7]],
                              data_medium[chain_col[4][7]]])
    large_chain = pd.concat([data_hard[chain_col[1][7]], data_hard[chain_col[2][7]], data_hard[chain_col[3][7]],
                             data_hard[chain_col[4][7]]])

    small_CC = pd.concat([data_simple[CC_col[1][7]], data_simple[CC_col[2][7]], data_simple[CC_col[3][7]], data_simple[CC_col[4][7]], data_simple[CC_col[5][7]], data_simple[CC_col[7][7]]])
    medium_CC = pd.concat([data_medium[CC_col[1][7]], data_medium[CC_col[2][7]], data_medium[CC_col[3][7]], data_medium[CC_col[4][7]], data_medium[CC_col[5][7]], data_medium[CC_col[7][7]]])
    large_CC = pd.concat([data_hard[CC_col[1][7]], data_hard[CC_col[2][7]], data_hard[CC_col[3][7]], data_hard[CC_col[4][7]], data_hard[CC_col[5][7]], data_hard[CC_col[7][7]]])

    small_CE = pd.concat([data_simple[CE_col[2][7]], data_simple[CE_col[3][7]], data_simple[CE_col[4][7]], data_simple[CE_col[5][7]], data_simple[CE_col[6][7]], data_simple[CE_col[7][7]]])
    medium_CE = pd.concat([data_medium[CE_col[2][7]], data_medium[CE_col[3][7]], data_medium[CE_col[4][7]], data_medium[CE_col[5][7]], data_medium[CE_col[6][7]], data_medium[CE_col[7][7]]])
    large_CE = pd.concat([data_hard[CE_col[2][7]], data_hard[CE_col[3][7]], data_hard[CE_col[4][7]], data_hard[CE_col[5][7]], data_hard[CE_col[6][7]], data_hard[CE_col[7][7]]])
    ...
    # chain
    small_medium = sm.stats.proportion.score_test_proportions_2indep(len(small_chain_true), len(small_chain),
                                                                     len(medium_chain_true), len(medium_chain)).pvalue
    medium_large = sm.stats.proportion.score_test_proportions_2indep(len(large_chain_true), len(large_chain),
                                                                     len(medium_chain_true), len(medium_chain)).pvalue
    small_large = sm.stats.proportion.score_test_proportions_2indep(len(small_chain_true), len(small_chain),
                                                                    len(large_chain_true), len(large_chain)).pvalue

    rows.append(["chain no-change", "small - large", len(small_chain_true)/len(small_chain), len(medium_chain_true)/len(medium_chain), len(large_chain_true)/len(large_chain), small_medium, medium_large, small_large])

    # CC
    small_medium = sm.stats.proportion.score_test_proportions_2indep(len(small_CC_true), len(small_CC),
                                                                     len(medium_CC_true), len(medium_CC)).pvalue
    medium_large = sm.stats.proportion.score_test_proportions_2indep(len(large_CC_true), len(large_CC),
                                                                     len(medium_CC_true), len(medium_CC)).pvalue
    small_large = sm.stats.proportion.score_test_proportions_2indep(len(small_CC_true), len(small_CC),
                                                                    len(large_CC_true), len(large_CC)).pvalue

    rows.append(["CC no-change", "small - large", len(small_CC_true)/len(small_CC), len(medium_CC_true)/len(medium_CC), len(large_CC_true)/len(large_CC), small_medium, medium_large, small_large])

    # CE
    small_medium = sm.stats.proportion.score_test_proportions_2indep(len(small_CE_true), len(small_CE),
                                                                     len(medium_CE_true), len(medium_CE)).pvalue
    medium_large = sm.stats.proportion.score_test_proportions_2indep(len(large_CE_true), len(large_CE),
                                                                     len(medium_CE_true), len(medium_CE)).pvalue
    small_large = sm.stats.proportion.score_test_proportions_2indep(len(small_CE_true), len(small_CE),
                                                                    len(large_CE_true), len(large_CE)).pvalue

    rows.append(["CE no-change", "small - large", len(small_CE_true)/len(small_CE), len(medium_CE_true)/len(medium_CE), len(large_CE_true)/len(large_CE), small_medium, medium_large, small_large])

    # small
    chain_CC = sm.stats.proportion.score_test_proportions_2indep(len(small_chain_true), len(small_chain),
                                                                 len(small_CC_true), len(small_CC)).pvalue
    CC_CE = sm.stats.proportion.score_test_proportions_2indep(len(small_CC_true), len(small_CC), len(small_CE_true),
                                                              len(small_CE)).pvalue
    chain_CE = sm.stats.proportion.score_test_proportions_2indep(len(small_chain_true), len(small_chain),
                                                                 len(small_CE_true), len(small_CE)).pvalue

    rows.append(["small no-change", "chain - CE", chain_CC, CC_CE, chain_CE])

    # medium
    chain_CC = sm.stats.proportion.score_test_proportions_2indep(len(medium_chain_true), len(medium_chain),
                                                                 len(medium_CC_true), len(medium_CC)).pvalue
    CC_CE = sm.stats.proportion.score_test_proportions_2indep(len(medium_CC_true), len(medium_CC), len(medium_CE_true),
                                                              len(medium_CE)).pvalue
    chain_CE = sm.stats.proportion.score_test_proportions_2indep(len(medium_chain_true), len(medium_chain),
                                                                 len(medium_CE_true), len(medium_CE)).pvalue

    rows.append(["medium no-change", "chain - CE", chain_CC, CC_CE, chain_CE])

    # large
    chain_CC = sm.stats.proportion.score_test_proportions_2indep(len(large_chain_true), len(large_chain),
                                                                 len(large_CC_true), len(large_CC)).pvalue
    CC_CE = sm.stats.proportion.score_test_proportions_2indep(len(large_CC_true), len(large_CC), len(large_CE_true),
                                                              len(large_CE)).pvalue
    chain_CE = sm.stats.proportion.score_test_proportions_2indep(len(large_chain_true), len(large_chain),
                                                                 len(large_CE_true), len(large_CE)).pvalue

    rows.append(["large no-change", "chain - CE", chain_CC, CC_CE, chain_CE])
...
def ConfidentialityTest(data):
    ...
    for qnum in range(1, 6):  # adding chain
        ...
        data_simple_right = data_simple[data_simple[chain_col[qnum][2]] == True]
        data_medium_right = data_medium[data_medium[chain_col[qnum][2]] == True]
        data_hard_right = data_hard[data_hard[chain_col[qnum][2]] == True]

        small_medium_all = stats.ranksums(data_simple[chain_col[qnum][8]], data_medium[chain_col[qnum][8]]).pvalue
        medium_large_all = stats.ranksums(data_hard[chain_col[qnum][8]], data_medium[chain_col[qnum][8]]).pvalue
        small_large_all = stats.ranksums(data_simple[chain_col[qnum][8]], data_hard[chain_col[qnum][8]]).pvalue

        small_medium_correct = stats.ranksums(data_simple_right[chain_col[qnum][8]],
                                              data_medium_right[chain_col[qnum][8]]).pvalue
        medium_large_correct = stats.ranksums(data_hard_right[chain_col[qnum][8]],
                                              data_medium_right[chain_col[qnum][8]]).pvalue
        small_large_correct = stats.ranksums(data_simple_right[chain_col[qnum][8]],
                                             data_hard_right[chain_col[qnum][8]]).pvalue

        small_chain_right = pd.concat([small_chain_right, data_simple_right[chain_col[qnum][8]]])
        medium_chain_right = pd.concat([medium_chain_right, data_medium_right[chain_col[qnum][8]]])
        large_chain_right = pd.concat([large_chain_right, data_hard_right[chain_col[qnum][8]]])

        rows.append(["chain", qnum, data_simple[chain_col[qnum][8]].mean(), data_simple[chain_col[qnum][8]].std(),
                     data_medium[chain_col[qnum][8]].mean(), data_medium[chain_col[qnum][8]].std(),
                     data_hard[chain_col[qnum][8]].mean(), data_hard[chain_col[qnum][8]].std(), small_medium_all,
                     medium_large_all, small_large_all, data_simple_right[chain_col[qnum][8]].mean(),
                     data_simple_right[chain_col[qnum][8]].std(), data_medium_right[chain_col[qnum][8]].mean(),
                     data_medium_right[chain_col[qnum][8]].std(), data_hard_right[chain_col[qnum][8]].mean(),
                     data_hard_right[chain_col[qnum][8]].std(), small_medium_correct, medium_large_correct,
                     small_large_correct])

    for qnum in range(1, 8):  # adding common cause

        data_simple_right = data_simple[data_simple[CC_col[qnum][2]] == True]
        data_medium_right = data_medium[data_medium[CC_col[qnum][2]] == True]
        data_hard_right = data_hard[data_hard[CC_col[qnum][2]] == True]

        small_medium_all = stats.ranksums(data_simple[CC_col[qnum][8]], data_medium[CC_col[qnum][8]]).pvalue
        medium_large_all = stats.ranksums(data_hard[CC_col[qnum][8]], data_medium[CC_col[qnum][8]]).pvalue
        small_large_all = stats.ranksums(data_simple[CC_col[qnum][8]], data_hard[CC_col[qnum][8]]).pvalue

        small_medium_correct = stats.ranksums(data_simple_right[CC_col[qnum][8]],
                                              data_medium_right[CC_col[qnum][8]]).pvalue
        medium_large_correct = stats.ranksums(data_hard_right[CC_col[qnum][8]],
                                              data_medium_right[CC_col[qnum][8]]).pvalue
        small_large_correct = stats.ranksums(data_simple_right[CC_col[qnum][8]],
                                             data_hard_right[CC_col[qnum][8]]).pvalue

        small_CC_right = pd.concat([small_CC_right, data_simple_right[CC_col[qnum][8]]])
        medium_CC_right = pd.concat([medium_CC_right, data_medium_right[CC_col[qnum][8]]])
        large_CC_right = pd.concat([large_CC_right, data_hard_right[CC_col[qnum][8]]])

        rows.append(["CC", qnum, data_simple[CC_col[qnum][8]].mean(), data_simple[CC_col[qnum][8]].std(),
                     data_medium[CC_col[qnum][8]].mean(), data_medium[CC_col[qnum][8]].std(),
                     data_hard[CC_col[qnum][8]].mean(), data_hard[CC_col[qnum][8]].std(), small_medium_all,
                     medium_large_all, small_large_all, data_simple_right[CC_col[qnum][8]].mean(),
                     data_simple_right[CC_col[qnum][8]].std(), data_medium_right[CC_col[qnum][8]].mean(),
                     data_medium_right[CC_col[qnum][8]].std(), data_hard_right[CC_col[qnum][8]].mean(),
                     data_hard_right[CC_col[qnum][8]].std(), small_medium_correct, medium_large_correct,
                     small_large_correct])

    for qnum in range(1, 8):  # adding common effect

        data_simple_right = data_simple[data_simple[CE_col[qnum][2]] == True]
        data_medium_right = data_medium[data_medium[CE_col[qnum][2]] == True]
        data_hard_right = data_hard[data_hard[CE_col[qnum][2]] == True]

        small_medium_all = stats.ranksums(data_simple[CE_col[qnum][8]], data_medium[CE_col[qnum][8]]).pvalue
        medium_large_all = stats.ranksums(data_hard[CE_col[qnum][8]], data_medium[CE_col[qnum][8]]).pvalue
        small_large_all = stats.ranksums(data_simple[CE_col[qnum][8]], data_hard[CE_col[qnum][8]]).pvalue

        small_medium_correct = stats.ranksums(data_simple_right[CE_col[qnum][8]],
                                              data_medium_right[CE_col[qnum][8]]).pvalue
        medium_large_correct = stats.ranksums(data_hard_right[CE_col[qnum][8]],
                                              data_medium_right[CE_col[qnum][8]]).pvalue
        small_large_correct = stats.ranksums(data_simple_right[CE_col[qnum][8]],
                                             data_hard_right[CE_col[qnum][8]]).pvalue

        small_CE_right = pd.concat([small_CE_right, data_simple_right[CE_col[qnum][8]]])
        medium_CE_right = pd.concat([medium_CE_right, data_medium_right[CE_col[qnum][8]]])
        large_CE_right = pd.concat([large_CE_right, data_hard_right[CE_col[qnum][8]]])

        rows.append(["CE", qnum, data_simple[CE_col[qnum][8]].mean(), data_simple[CE_col[qnum][8]].std(),
                     data_medium[CE_col[qnum][8]].mean(), data_medium[CE_col[qnum][8]].std(),
                     data_hard[CE_col[qnum][8]].mean(), data_hard[CE_col[qnum][8]].std(), small_medium_all,
                     medium_large_all, small_large_all, data_simple_right[CE_col[qnum][8]].mean(),
                     data_simple_right[CE_col[qnum][8]].std(), data_medium_right[CE_col[qnum][8]].mean(),
                     data_medium_right[CE_col[qnum][8]].std(), data_hard_right[CE_col[qnum][8]].mean(),
                     data_hard_right[CE_col[qnum][8]].std(), small_medium_correct, medium_large_correct,
                     small_large_correct])

    # combined
    small_chain = pd.concat([data_simple[chain_col[1][8]], data_simple[chain_col[2][8]], data_simple[chain_col[3][8]],
                             data_simple[chain_col[4][8]], data_simple[chain_col[5][8]]])
    medium_chain = pd.concat([data_medium[chain_col[1][8]], data_medium[chain_col[2][8]], data_medium[chain_col[3][8]],
                              data_medium[chain_col[4][8]], data_medium[chain_col[5][8]]])
    large_chain = pd.concat(
        [data_hard[chain_col[1][8]], data_hard[chain_col[2][8]], data_hard[chain_col[3][8]], data_hard[chain_col[4][8]],
         data_hard[chain_col[5][8]]])

    small_CC = pd.concat(
        [data_simple[CC_col[1][8]], data_simple[CC_col[2][8]], data_simple[CC_col[3][8]], data_simple[CC_col[4][8]],
         data_simple[CC_col[5][8]], data_simple[CC_col[6][8]], data_simple[CC_col[7][8]]])
    medium_CC = pd.concat(
        [data_medium[CC_col[1][8]], data_medium[CC_col[2][8]], data_medium[CC_col[3][8]], data_medium[CC_col[4][8]],
         data_medium[CC_col[5][8]], data_medium[CC_col[6][8]], data_medium[CC_col[7][8]]])
    large_CC = pd.concat(
        [data_hard[CC_col[1][8]], data_hard[CC_col[2][8]], data_hard[CC_col[3][8]], data_hard[CC_col[4][8]],
         data_hard[CC_col[5][6]], data_hard[CC_col[6][8]], data_hard[CC_col[7][8]]])

    small_CE = pd.concat(
        [data_simple[CE_col[1][8]], data_simple[CE_col[2][8]], data_simple[CE_col[3][8]], data_simple[CE_col[4][8]],
         data_simple[CE_col[5][8]], data_simple[CE_col[6][8]], data_simple[CE_col[7][8]]])
    medium_CE = pd.concat(
        [data_medium[CE_col[1][8]], data_medium[CE_col[2][8]], data_medium[CE_col[3][8]], data_medium[CE_col[4][8]],
         data_medium[CE_col[5][8]], data_medium[CE_col[6][8]], data_medium[CE_col[7][8]]])
    large_CE = pd.concat(
        [data_hard[CE_col[1][8]], data_hard[CE_col[2][8]], data_hard[CE_col[3][8]], data_hard[CE_col[4][8]],
         data_hard[CE_col[5][8]], data_hard[CE_col[6][8]], data_hard[CE_col[7][8]]])
    ...
    rows.append(
        ["chain", "small - large all", small_chain.mean(), small_chain.std(), medium_chain.mean(), medium_chain.std(),
         large_chain.mean(), large_chain.std(), small_medium_all, medium_large_all, small_large_all])
    ...
    rows.append(
        ["CC", "small - large all", small_CC.mean(), small_CC.std(), medium_CC.mean(), medium_CC.std(), large_CC.mean(),
         large_CC.std(), small_medium_all, medium_large_all, small_large_all])
    ...
    rows.append(
        ["CE", "small - large all", small_CE.mean(), small_CE.std(), medium_CE.mean(), medium_CE.std(), large_CE.mean(),
         large_CE.std(), small_medium_all, medium_large_all, small_large_all])
    ...
    rows.append(["small", "chain - CE all", small_chain.mean(), small_chain.std(), small_CC.mean(), small_CC.std(),
                 small_CE.mean(), small_CE.std(), chain_CC_all, CC_CE_all, chain_CE_all])
    ...
    rows.append(["medium", "chain - CE all", medium_chain.mean(), medium_chain.std(), medium_CC.mean(), medium_CC.std(),
                 medium_CE.mean(), medium_CE.std(), chain_CC_all, CC_CE_all, chain_CE_all])
    ...
    rows.append(["large", "chain - CE all", large_chain.mean(), large_chain.std(), large_CC.mean(), large_CC.std(),
                 large_CE.mean(), large_CE.std(), chain_CC_all, CC_CE_all, chain_CE_all])
    ...
    rows.append(
        ["chain", "small - large right", small_chain_right.mean(), small_chain_right.std(), medium_chain_right.mean(),
         medium_chain_right.std(), large_chain_right.mean(), large_chain_right.std(), small_medium_right,
         medium_large_right, small_large_right])
    ...
    rows.append(["CC", "small - large right", small_CC_right.mean(), small_CC_right.std(), medium_CC_right.mean(),
                 medium_CC_right.std(), large_CC_right.mean(), large_CC_right.std(), small_medium_right,
                 medium_large_right, small_large_right])
    ...
    rows.append(["CE", "small - large right", small_CE_right.mean(), small_CE_right.std(), medium_CE_right.mean(),
                 medium_CE_right.std(), large_CE_right.mean(), large_CE_right.std(), small_medium_right,
                 medium_large_right, small_large_right])
    ...
    rows.append(["small", "chain - CE right", small_chain_right.mean(), small_chain_right.std(), small_CC_right.mean(),
                 small_CC_right.std(), small_CE_right.mean(), small_CE_right.std(), chain_CC_right, CC_CE_right,
                 chain_CE_right])
    ...
    rows.append(
        ["medium", "chain - CE right", medium_chain_right.mean(), medium_chain_right.std(), medium_CC_right.mean(),
         medium_CC_right.std(), medium_CE_right.mean(), medium_CE_right.std(), chain_CC_right, CC_CE_right,
         chain_CE_right])
    ...
    rows.append(["large", "chain - CE right", large_chain_right.mean(), large_chain_right.std(), large_CC_right.mean(),
                 large_CC_right.std(), large_CE_right.mean(), large_CE_right.std(), chain_CC_right, CC_CE_right,
                 chain_CE_right])

    table = pd.DataFrame(rows)
    table.to_csv("Stats\\Confidence1.csv", header=False, index=False)
...
def DseparationTest(data):
    ...
    data_simple_true = data_simple[data_simple[chain_col[5][0]] == True]
    data_medium_true = data_medium[data_medium[chain_col[5][0]] == True]
    data_hard_true = data_hard[data_hard[chain_col[5][0]] == True]

    small_medium = sm.stats.proportion.score_test_proportions_2indep(len(data_simple_true), len(data_simple),
                                                                     len(data_medium_true), len(data_medium)).pvalue
    medium_large = sm.stats.proportion.score_test_proportions_2indep(len(data_hard_true), len(data_hard),
                                                                     len(data_medium_true), len(data_medium)).pvalue
    small_large = sm.stats.proportion.score_test_proportions_2indep(len(data_simple_true), len(data_simple),
                                                                    len(data_hard_true), len(data_hard)).pvalue

    rows.append(["chain", 5, small_medium, medium_large, small_large])

    #adding CC Q6

    data_simple_true = data_simple[data_simple[CC_col[6][0]] == True]
    data_medium_true = data_medium[data_medium[CC_col[6][0]] == True]
    data_hard_true = data_hard[data_hard[CC_col[6][0]] == True]
    ...
    rows.append(["CC", 6, small_medium, medium_large, small_large])

    # Adding CE Q1

    data_simple_true = data_simple[data_simple[CE_col[1][0]] == True]
    data_medium_true = data_medium[data_medium[CE_col[1][0]] == True]
    data_hard_true = data_hard[data_hard[CE_col[1][0]] == True]
    ...
    rows.append(["CE", 1, small_medium, medium_large, small_large])


    table = pd.DataFrame(rows)
    table.to_csv('Stats/Dseparation.csv', header=False, index=False)
...
#DseparationTest(data)
ConfidentialityTest(data)